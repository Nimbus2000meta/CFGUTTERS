...
async def submit_contact_form(form_data: ContactFormSubmission):
    try:
        ...
        # Build additional concerns HTML if provided
        additional_concerns_html = (
            ...
            """
            if form_data.additionalConcerns
            else ""
        )

        # Compose email body in HTML
        email_html = f"""
        <html>
        ...
        # Define recipient list with all addresses you want to notify
        recipients = [
            "louis@cfgutters.com",
