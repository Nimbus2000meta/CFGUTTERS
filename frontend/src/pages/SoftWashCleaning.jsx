      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div>
            ...
            <div className="bg-purple-50 p-8 rounded-xl mb-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Our Process:</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <FiCheckCircle className="text-purple-600 text-2xl mt-1 flex-shrink-0" />
                  <div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Dramatic Before & After Results</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-xl overflow-hidden shadow-lg">
              <img 
                src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/Y13juaD58zAYXRBJ4Yz1/media/67be03c0c8e5a8d1834271f8.png" 
                alt="Before Soft Wash"
