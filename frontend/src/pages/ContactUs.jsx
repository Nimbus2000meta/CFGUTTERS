      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <a href="tel:+18458793864" className="text-primary-600 hover:text-primary-700 text-lg font-semibold">
              +1 (845) 879-3864
            </a>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <a href="mailto:cfgutters02@gmail.com" className="text-secondary-600 hover:text-secondary-700 text-lg font-semibold">
