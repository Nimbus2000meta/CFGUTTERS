...
const Gallery = () => {
  ...
  const galleryImages = [
    ...
    { id: 7, src: '/images/before-after-7.png', alt: 'Before: Gutter with moss and growth', label: 'Before' },
    { id: 8, src: '/images/before-after-8.png', alt: 'After: Pristine gutter system', label: 'After' },
  ];
